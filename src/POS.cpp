#include <U8g2lib.h>
#include <Arduino.h>
// U8G2_KS0108_ERM19264_F u8g2(U8G2_R2, 13, 12, 14, 27, 26, 25, 33, 32, /*enable=*/17, /*dc=*/16, /*cs0=*/5, /*cs1=*/18, /*cs2=*/19, /* reset=*/U8X8_PIN_NONE);  // Set R/W to low!
...
void loop() {
  ...
  getdata();
  display();u8g2.setFont(u8g2_font_open_iconic_all_8x_t);
  for (int i = 0; i <= 286; i += 3) {
    u8g2.clearBuffer();
